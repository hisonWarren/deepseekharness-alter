window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			"[data-dsh-auto-review-button]{border:0!important;background:transparent!important;min-height:28px!important;padding:3px 6px!important;gap:4px!important;border-radius:8px!important;font:inherit!important;font-size:12px!important;line-height:18px!important;color:var(--dsw-alias-label-tertiary,#81858c)!important;outline:none!important;box-shadow:none!important}",
			...
			"[data-dsh-auto-review-button]:focus,[data-dsh-auto-review-button]:focus-visible{outline:none!important;box-shadow:none!important;border:0!important}",
			/* AI 审查 panel → mature status card */
			"[data-dsh-auto-review-panel]{z-index:12000!important;min-width:300px!important;max-width:380px!important;padding:14px!important;border-radius:12px!important;border:1px solid var(--dsw-alias-border-l2,rgba(127,127,127,.22))!important;background:var(--dsw-alias-bg-elevated,var(--dsw-alias-bg-module-platform,#fff))!important;box-shadow:0 12px 32px rgba(0,0,0,.12)!important;color:var(--dsw-alias-label-primary,#1d1d1f)!important;font-size:12px!important;line-height:1.45!important}",
			"[data-dsh-auto-review-panel]>[data-dsh-auto-review-title]{font-size:13px!important;font-weight:600!important;letter-spacing:.01em!important;margin:0 0 10px!important;padding:0 0 10px!important;border-bottom:1px solid var(--dsw-alias-border-l1,rgba(127,127,127,.14))!important}",
			"[data-dsh-auto-review-panel] [data-dsh-auto-review-row]{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important;padding:7px 0!important;min-height:28px!important}",
			"[data-dsh-auto-review-panel] [data-dsh-auto-review-row]>span:first-child{color:var(--dsw-alias-label-tertiary,#81858c)!important;flex:none!important}",
			"[data-dsh-auto-review-panel] [data-dsh-auto-review-row]>span:last-child{color:var(--dsw-alias-label-primary,#1d1d1f)!important;text-align:right!important;font-variant-numeric:tabular-nums!important}",
			"[data-dsh-auto-review-muted]{color:var(--dsw-alias-label-caption,rgba(127,127,127,.72))!important}",
			"[data-dsh-auto-review-switch]{appearance:none!important;min-height:26px!important;padding:3px 10px!important;border-radius:8px!important;border:1px solid var(--dsw-alias-border-l2,rgba(127,127,127,.28))!important;background:transparent!important;color:var(--dsw-alias-label-secondary,#61666b)!important;font:inherit!important;font-size:12px!important;line-height:18px!important}",
			"[data-dsh-auto-review-switch]+[data-dsh-auto-review-switch]{margin-left:6px!important}",
			"[data-dsh-auto-review-switch]:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,rgba(127,127,127,.1))!important;color:var(--dsw-alias-label-primary)!important}",
			"[data-dsh-auto-review-switch]:disabled{opacity:1!important;background:var(--dsw-alias-interactive-bg-hover,rgba(127,127,127,.12))!important;color:var(--dsw-alias-label-primary,#1d1d1f)!important;border-color:transparent!important;font-weight:600!important;cursor:default!important}",
			"[data-dsh-auto-review-section]{margin:10px 0 0!important;padding:10px 0 0!important;border-top:1px solid var(--dsw-alias-border-l1,rgba(127,127,127,.14))!important}",
